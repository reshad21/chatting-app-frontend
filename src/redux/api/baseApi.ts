...
import type { BaseQueryApi, BaseQueryFn, DefinitionType, FetchArgs } from "@reduxjs/toolkit/query/react";
...
export const baseApi = createApi({
    ...
    tagTypes: ['bikes', 'user', 'conversation', 'messages', 'booking', 'subscriptions'],
    endpoints: () => ({}),
});